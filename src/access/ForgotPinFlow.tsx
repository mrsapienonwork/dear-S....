          ...
          >
            <div className="glass-panel border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden backdrop-blur-xl">
              ...
              <div className="space-y-4 mb-8 text-left">
                ...
                <div className="space-y-1">
                  ...
                  <input 
                    ...
                    className={`w-full glass-input border ${error ? 'border-red-500' : 'border-white/5'} rounded-xl px-4 py-3.5 text-white text-sm outline-none focus:border-violet-500 transition-colors`}
                  />
              ...
              <div className="flex gap-4">
                <button 
                  onClick={onBack}
                  className="w-1/3 px-4 py-3 rounded-xl border border-white/10 text-gray-400 hover:text-white transition-colors text-sm font-medium tracking-wide"
                >
                  Cancel
                </button>
                <button 
                  ...
                  className="flex-1 py-3 rounded-xl font-semibold glass-button text-white border-transparent hover:border-violet-500/50 disabled:bg-white/5 disabled:text-gray-500 transition-all"
                >
                  Verify
                </button>
              </div>
          ...
          >
            <div className="glass-panel border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden backdrop-blur-xl">
              ...
              <div className="space-y-6">
                ...
                <div className={`transition-opacity duration-300 ${newPin.length === 6 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
