...
export function LockScreen() {
 ...
 onClick={handleEnter}
 className="w-full py-3 mt-2 rounded-xl font-semibold glass-button text-white border-transparent hover:border-violet-500/50 disabled:bg-white/5 disabled:text-gray-500 "
 >
 Enter System
 </button>
 ...
 className="text-xs text-gray-500 hover:text-violet-400 tracking-widest uppercase"
 >
 Forgot PIN?
 </button>
 </div>
