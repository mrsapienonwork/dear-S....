    ...
    return (
      <div className="glass-panel border border-white/5 rounded-2xl p-5 md:p-8 shadow-sm text-center">
         ...
         <button 
            ...
            className="px-6 py-2 bg-white/10 hover:bg-white/20 text-white rounded-xl transition-all text-sm font-medium"
         >
            Reload App
         </button>
      </div>
        ...
        <div className="glass-panel border border-white/5 rounded-2xl p-5 md:p-8 shadow-sm">
           ...
           <div className="space-y-6">
              ...
              {mode === 'change_recovery' && currentPinInput.length === 6 && (
                 <div className="space-y-4">
                    <div className="space-y-1">
                       ...
                       className="w-full glass-input rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-violet-500 transition-colors"
                       />
                    </div>
                    <div className="space-y-1">
              ...
              <div className="flex gap-4 pt-4">
                 <button 
                 onClick={clearState}
                 className="flex-1 py-3 rounded-xl border border-white/10 text-white hover:bg-white/5 transition-all text-sm font-semibold"
                 >
                 Cancel
                 </button>
                 <button 
                 ...
                 className="flex-1 py-3 rounded-xl glass-button text-white border-transparent hover:border-violet-500/50 disabled:bg-white/10 disabled:text-gray-500 transition-all text-sm font-semibold"
                 >
                 Confirm
                 </button>
              </div>
  ...
  return (
    <div className="glass-panel border border-white/5 rounded-2xl shadow-sm overflow-hidden">
      ...
      <div className="divide-y divide-white/5">
        <button 
          onClick={lockAppNow}
          className="w-full flex items-center gap-4 p-5 md:px-8 hover:bg-white/5 transition-colors text-left group"
        >
        ...
        <button 
          ...
          className="w-full flex items-center gap-4 p-5 md:px-8 hover:bg-red-500/5 transition-colors text-left group"
        >
