...
function PinSetupCard() {
 ...
 <div className={` ${pin.length === 6 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
...
function RecoverySetupCard() {
 ...
 className="w-full glass-input rounded-xl px-4 py-3.5 text-white text-sm outline-none focus:border-violet-500 placeholder:text-gray-600"
 />
 </div>
 <div className="space-y-1">
