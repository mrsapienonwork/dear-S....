...
export function Analytics() {
  ...
  return (
    ...
    >
      {/* A) TOP HERO SECTION */}
      <motion.div variants={slideUpItem} className="flex flex-col xl:flex-row gap-6 justify-between xl:items-end pb-2">
        <div>
      ...
      <motion.div variants={staggerContainer} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <motion.div variants={slideUpItem} className="glass-panel border border-white/5 rounded-2xl p-5 shadow-sm flex flex-col">
      ...
      <motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* C) SCORE BREAKDOWN */}
        <motion.div variants={slideUpItem} className="glass-panel border border-white/5 rounded-2xl p-5 flex flex-col shadow-sm">
           ...
           <div className="flex gap-1 flex-wrap mt-auto pt-4 border-t border-white/10">
              {chartData.map((d, i) => (
                <div 
                   ...
                   className={cn(
                     "w-[12.5%] aspect-square rounded-[2px] transition-colors duration-300",
