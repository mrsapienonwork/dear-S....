...
import { staggerContainer, slideUpItem, glassCardHover } from '../lib/motion';
...
export function Dashboard() {
  ...
  return (
    ...
    >
      <motion.header variants={slideUpItem} className="space-y-2">
      ...
      {todayScore ? (
        <React.Fragment>
          ...
          <motion.div variants={slideUpItem} className="mt-4">
        ...
        <motion.div variants={slideUpItem} className="p-6 md:p-8 rounded-3xl glass-panel border border-white/5 bg-black/20 flex flex-col items-center justify-center text-center gap-4">
      ...
      {/* Stats Grid */}
      <motion.div variants={slideUpItem} className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
      ...
      {/* Today's Overview */}
      <motion.section variants={slideUpItem} className="glass-panel border border-white/5 rounded-2xl p-5 md:p-8 shadow-sm">
      ...
      {/* Secondary Stats */}
      <motion.div variants={slideUpItem} className="grid grid-cols-2 md:grid-cols-4 gap-4">
