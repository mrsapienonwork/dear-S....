...
export function FocusMode() {
 ...
 // Phase will be handled by the effect
 } else {
 ...
 const glassButtonClasses = "bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] border border-[rgba(255,255,255,0.2)] hover:bg-[rgba(120,80,255,0.3)] text-white";
 ...
 <NavLink 
 to="/letters" 
 className="text-xs font-medium text-white/40 hover:text-white flex items-center gap-1.5 opacity-0 group-hover:opacity-100 bg-white/5 hover:bg-white/10 px-3 py-1.5 rounded-full border border-white/5"
 >
 <Mail size={12} />
 View all
 </NavLink>
 ...
 <div className={cn(
 "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full blur-[100px] opacity-20 ",
 ...
 <button 
 onClick={resetTimer}
 className={cn("w-14 h-14 rounded-full flex items-center justify-center group ", glassButtonClasses)}
 >
 ...
 <button 
 onClick={toggleTimer}
 className="w-20 h-20 rounded-full flex items-center justify-center bg-white text-black hover:bg-gray-200 shadow-[0_0_30px_rgba(255,255,255,0.2)]"
 >
 ...
 <button
 onClick={skipPhase}
 className={cn("w-14 h-14 rounded-full flex items-center justify-center ", glassButtonClasses)}
 >
 ...
 >
 <div className={cn(
 "w-5 h-5 bg-white rounded-full absolute top-0.5 shadow-sm",
