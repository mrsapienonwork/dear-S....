...
const glassButtonClasses = "bg-[rgba(255,255,255,0.08)] backdrop-blur-[10px] border border-[rgba(255,255,255,0.15)] hover:bg-[rgba(255,255,255,0.12)] hover:border-[rgba(255,255,255,0.25)] transition-all duration-300 text-white rounded-xl";
                ...
                <AnimatePresence>
                  {filteredLetters.map((letter) => (
                    <motion.div 
                      ...
                      className={cn(
                        glassCardClasses,
                        "p-6 cursor-pointer group transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.6)] hover:border-white/20 hover:bg-[rgba(255,255,255,0.08)]"
                      )}
                    >
                      ...
                      <p className="text-white/70 text-base leading-relaxed line-clamp-2 font-light group-hover:text-white/90 transition-colors">
                        "{letter.text}"
                      </p>
                    </motion.div>
                  ))}
        ...
        {(view === 'create' || view === 'edit') && (
          ...
          >
            <button 
              ...
              className="flex items-center gap-2 text-white/50 hover:text-white transition-colors mb-8 w-fit text-sm font-medium"
            >
            ...
            <div className={cn(glassCardClasses, "p-6 md:p-10 space-y-8")}>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {(['future', 'reality', 'support'] as const).map((type) => (
                    <button
                      ...
                      className={cn(
                        "py-3 px-2 rounded-xl text-sm font-medium transition-all border flex items-center justify-center text-center",
                        newType === type 
                          ? getBadgeColor(type) 
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  className="w-full h-64 bg-black/20 border border-white/5 rounded-2xl p-6 text-lg text-white/90 leading-relaxed placeholder:text-white/20 focus:outline-none focus:ring-1 focus:ring-white/20 focus:border-white/20 resize-none transition-all"
                />
              </div>
              ...
              <button
                ...
                className={cn(
                  "w-full py-4 rounded-xl font-semibold tracking-wide transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]",
                  newText.trim() 
                    ? "bg-white text-black hover:bg-gray-200 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-[1.01]" 
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="p-2.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 hover:bg-rose-500/20 hover:text-rose-300 transition-all"
                >
                  <Trash2 size={16} />
                </button>
              </div>
