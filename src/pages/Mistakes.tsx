...
export function Mistakes() {
  ...
  return (
    ...
    >
      {/* Header */}
      <motion.div variants={slideUpItem} className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 relative">
        ...
        <motion.button 
            ...
            className="flex items-center justify-center gap-2 text-sm font-semibold text-black bg-white hover:bg-gray-100 px-5 py-2.5 rounded-xl transition-colors shadow-lg shadow-white/5 whitespace-nowrap"
        >
      ...
      {/* Tabs */}
      <motion.div variants={slideUpItem} className="flex space-x-1.5 overflow-x-auto pb-2 scrollbar-hide snap-x relative border-b border-white/5">
        <button
            onClick={() => setActiveTab('all')}
            className={`relative snap-start px-5 py-2.5 rounded-lg whitespace-nowrap text-sm font-medium transition-colors duration-300 ${
            activeTab === 'all' 
                ? 'text-white' 
        ...
        >
            ...
            {activeTab === 'all' && (
              <motion.div 
                  layoutId="active-mistake-border"
                  className="absolute bottom-0 left-0 right-0 h-[2px] bg-white z-0"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 xl:col-span-9 space-y-6">
           ...
           {/* Utility Row */}
           <motion.div variants={slideUpItem} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="relative flex-1 min-w-0 w-full sm:max-w-md">
                 ...
                 <input 
                   ...
                   className="w-full bg-body-dark border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-gray-500 focus:border-violet-500/50 focus:bg-white/[0.02] transition-colors outline-none shadow-sm"
                 />
              </div>
              <div className="flex gap-2 w-full sm:w-auto">
                <div className="relative flex-1 sm:flex-none">
                  <select 
                    ...
                    className="w-full sm:w-auto bg-body-dark border border-white/10 rounded-xl pl-4 pr-10 py-2.5 text-sm text-gray-300 font-medium appearance-none cursor-pointer hover:text-white hover:border-white/20 transition-colors outline-none"
                  >
           ...
           <motion.div variants={slideUpItem} className="space-y-4">
             {mistakes.length === 0 ? (
                ...
                >
                    ...
                    <button onClick={openAddModal} className="flex items-center gap-2 text-sm font-semibold text-white bg-white/10 hover:bg-white/15 px-5 py-2.5 rounded-xl transition-colors border border-white/10">
        ...
        <div className="lg:col-span-4 xl:col-span-3 space-y-6">
           ...
           {/* Top Stats Compact */}
           <motion.div variants={slideUpItem} className="glass-panel border border-white/5 rounded-2xl p-5 shadow-sm space-y-6">
           ...
           {stats.total > 0 && (
             <motion.div variants={slideUpItem} className="glass-panel border border-white/5 bg-white/[0.01] rounded-2xl p-5 shadow-sm space-y-5">
             ...
             >
                ...
                <form onSubmit={saveMistake} className="p-6 space-y-6 overflow-y-auto custom-scrollbar flex-1">
                     ...
                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white/[0.01] p-4 rounded-xl border border-white/5">
                       <div className="space-y-1.5">
                         ...
                         <select 
                            ...
                            className="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-violet-500/50 transition-colors"
                          >
                       ...
                       <div className="space-y-1.5">
                         ...
                         <input 
                           ...
                           className="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-violet-500/50 placeholder-gray-600 transition-colors"
                         />
                       </div>
                   ...
                   <div className="space-y-4">
                     ...
                     <div className="space-y-1.5">
                         ...
                         <input 
                           ...
                           className="w-full bg-white/[0.02] border border-white/10 rounded-lg px-4 py-3 font-semibold text-white text-base outline-none focus:border-violet-500/50 placeholder-gray-600 transition-colors shadow-sm"
                         />
                     </div>
                     ...
                     <div className="space-y-1.5">
                        ...
                        <textarea 
                          ...
                          className="w-full bg-white/[0.01] border border-white/10 rounded-lg px-4 py-3 text-sm text-gray-300 outline-none focus:border-violet-500/50 resize-none placeholder-gray-600 transition-colors"
                        />
                     </div>
                     ...
                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                       <div className="space-y-1.5">
                          ...
                          <textarea 
                            ...
                            className="w-full bg-red-950/10 border border-red-500/20 rounded-lg px-4 py-3 text-sm text-red-200/90 outline-none focus:border-red-500/50 resize-none placeholder-red-900/40 transition-colors"
                          />
                       </div>
                       ...
                       <div className="space-y-1.5">
                          ...
                          <textarea 
                            ...
                            className="w-full bg-green-950/10 border border-green-500/20 rounded-lg px-4 py-3 text-sm text-green-200/90 outline-none focus:border-green-500/50 resize-none placeholder-green-900/40 transition-colors"
                          />
                       </div>
                     </div>
                   </div>
                   ...
                   <div className="pt-6 pb-2 flex justify-end gap-3 flex-shrink-0">
                      <button type="button" onClick={() => setShowModal(false)} className="px-5 py-2 text-sm font-semibold text-gray-400 hover:text-white transition-colors">Cancel</button>
                      <button type="submit" className="px-6 py-2 bg-violet-600 hover:bg-violet-500 text-white text-sm font-bold rounded-lg transition-colors shadow-lg shadow-violet-500/20 flex items-center gap-2">
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
             ...
             >
                ...
                <div className="flex justify-end gap-3 flex-shrink-0">
                   <button onClick={() => setMistakeToDelete(null)} className="px-5 py-2.5 text-sm font-semibold text-gray-400 hover:text-white transition-colors rounded-lg">Cancel</button>
                   <button onClick={confirmDelete} className="px-6 py-2.5 bg-red-500/90 text-white text-sm font-bold rounded-lg hover:bg-red-500 transition-colors shadow-sm">Delete</button>
                </div>
             </motion.div>
          </div>
        )}
...
function MistakeCard({ mistake, subjectName, onEdit, onDelete, onToggleResolve }: { mistake: Mistake, subjectName: string, onEdit: () => void, onDelete: () => void, onToggleResolve: () => void }) {
  ...
  return (
    <motion.div 
      ...
      className={cn(
        "group relative bg-white/[0.015] border rounded-xl transition-all duration-300 overflow-hidden",
        isResolved ? "border-green-500/10" : "border-white/5 hover:border-white/10 hover:bg-white/[0.03]"
      )}
    >
      <div 
        className={cn("absolute left-0 top-0 bottom-0 w-[3px] transition-colors rounded-l-xl", 
      ...
      <div className="p-4 md:px-5 cursor-pointer pl-6" onClick={() => setExpanded(!expanded)}>
         <div className="flex justify-between items-start gap-4">
            <div className="flex-1 min-w-0">
               ...
               <h3 className={cn(
                 "text-base md:text-lg font-bold tracking-tight mb-1 transition-colors leading-tight",
            ...
            <div className="flex gap-1.5 isolate" onClick={e => e.stopPropagation()}>
               <div className="hidden sm:flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100 mr-2">
                 <button onClick={onEdit} className="p-2 rounded-lg text-gray-400 hover:text-white hover:bg-white/10 transition-colors" title="Edit">
                    <Edit2 className="w-4 h-4" />
                 </button>
                 <button onClick={onDelete} className="p-2 rounded-lg text-gray-400 hover:text-red-400 hover:bg-red-500/10 transition-colors" title="Delete">
               ...
               <button 
                 ...
                 className={cn(
                   "p-2 rounded-lg transition-all shadow-sm flex items-center justify-center border",
                   isResolved 
      ...
      <AnimatePresence>
         {expanded && (
           <motion.div 
             ...
             transition={{ duration: 0.25, ease: SYSTEM_EASE }}
           >
